...
string Settings::value(const string &_key, const string &defaultValue)
{
	string str = _key;
	string section, key;
	trim(str);
...
bool Settings::setValue(const string& _key, const string& _val)
{
	string str = _key;
	string section, key;
	size_t pos;
